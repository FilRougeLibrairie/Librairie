...
public class JFEditor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboTypeRecherche.setBounds(638, 30, 70, 20);
        ...
        labelModifier.setForeground(new java.awt.Color(255, 255, 255));
        labelModifier.setText("                 Modifier");
        labelModifier.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                labelModifierMouseClicked(evt);
            }
        });
        ...
        panelModifLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelModifLayout.createSequentialGroup()
                .addComponent(labelModifier, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        panelModifLayout.setVerticalGroup(
            panelModifLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelModifLayout.createSequentialGroup()
                .addComponent(labelModifier, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void labelRechercherOnPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelRechercherOnPanelMouseClicked
        // TODO add your handling code here:
        EditorDAO a = new EditorDAO();
        Vector<Editor> findAll = a.findAll();
        
        Vector<Editor> findByStatut1 = a.findByStatut(1);
        Vector<Editor> findByStatut2 = a.findByStatut(2);
        if (comboTypeRecherche.getItemAt(comboTypeRecherche.getSelectedIndex()).equals("Tous")) {
            StringBuilder str = new StringBuilder();

            for (int i = 0; i < findAll.size(); i++) {
                str.append(((Editor) a.findAll().get(i)).toString());
            ...
            for (int i = 0; i < a.findByCriteria(a.NAME, tfRechercher.getText()).size(); i++) {
                str.append(((Editor) a.findByCriteria(a.NAME, tfRechercher.getText()).get(i)).toString());

            }
            taResultatsRecherche.setText(str.toString());
            
        } if (comboTypeRecherche.getItemAt(comboTypeRecherche.getSelectedIndex()).equals("Id")) {
        ...
        } if (comboTypeRecherche.getItemAt(comboTypeRecherche.getSelectedIndex()).equals("Statut")) {
            
            if (tfRechercher.getText().equalsIgnoreCase("Actif")) {
                System.out.println("coucouuuuuuuuuuuuuuuuuuuuuuu");
                StringBuilder str = new StringBuilder();
                
                for (int i = 0; i < findByStatut1.size(); i++) {
                    
                    str.append(((Editor) a.findByStatut(1).get(i)).toString());
                    
                }
                
                taResultatsRecherche.setText(str.toString());
                
            } if (tfRechercher.getText().equalsIgnoreCase("Inactif")) {
                
                StringBuilder str = new StringBuilder();
                
                 for (int i = 0; i < findByStatut2.size(); i++) {
                     
                    str.append(((Editor) a.findByStatut(2).get(i)).toString());
    ...
    private void labelModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelModifierMouseClicked
        // TODO add your handling code here:
        tfNom.setEditable(true);
        tfStatut.setEditable(true);
        taPresentation.setEditable(true);
    }//GEN-LAST:event_labelModifierMouseClicked
