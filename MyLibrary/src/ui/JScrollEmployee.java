 ...
 * @author cdi312
 */
public class JScrollEmployee extends javax.swing.JFrame {

    /**
     * Creates new form JFPurchase
     */
    public JScrollEmployee() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JScrollEmployee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JScrollEmployee().setVisible(true);
            }
        });
    }
