...
public class BookLanguagePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jpPrinc, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 900, 520));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 50, 780, 30));
        ...
        jPanel1.add(jRUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 90, 103, 30));
        ...
        jPanel1.add(jRAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, 103, 30));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 140));
    ...
    private void jRUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRUpdateActionPerformed
        ...
        if (jRUpdate.isSelected() == true) {
            jpPrinc.removeAll();
            jpPrinc.validate();
            jpPrinc.add(new BookLanguageUpdatePanel(),BorderLayout.CENTER);
            jpPrinc.revalidate();
    ...
    private void jRAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRAddActionPerformed
        ...
        if (jRAdd.isSelected() == true) {
            jpPrinc.removeAll();
            jpPrinc.validate();
            jpPrinc.add(new BookLanguageAddPanel(),BorderLayout.CENTER);
            jpPrinc.revalidate();
            jpPrinc.setVisible(true);
        }
